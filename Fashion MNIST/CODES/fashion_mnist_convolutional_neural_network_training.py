...
def main():
    ...
    assert((54000, 28, 28, 1) == x_train.shape)
    assert((6000, 28, 28, 1) == x_val.shape)
    assert((10000, 28, 28, 1) == x_test.shape)
    assert((54000, 10) == y_train.shape)
    assert((6000, 10) == y_val.shape)
